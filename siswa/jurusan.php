            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="jurusan.php">Jurusan</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="tambahjurusan.php" class="btn btn-primary">Tambah Data</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php foreach ($jurusan as $i => $j): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($j['ketua']) ?></td>
                                                <td>
                                                    <a href="editjurusan.php" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
