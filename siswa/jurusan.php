...
$total_jurusan = $data ? mysqli_num_rows($data) : 0;
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Data Jurusan - Sistem Akademik PPLG 1</title>
...
<body id="page-top">
            ...
            <?php if ($_GET['status'] == 'deleted'): ?>
                <div class="toast-box toast-danger">
                    ...
                    <div class="toast-content">
                        <strong>Jurusan Dihapus!</strong>
                        <span>Data jurusan <?= isset($_GET['nama']) ? htmlspecialchars($_GET['nama']) : '' ?> berhasil dihapus.</span>
                    </div>
                </div>
            <?php elseif ($_GET['status'] == 'updated'): ?>
                <div class="toast-box toast-primary">
                    ...
                    <div class="toast-content">
                        ...
                        <span>Data jurusan berhasil diperbarui.</span>
                    </div>
                </div>
            <?php elseif ($_GET['status'] == 'added'): ?>
                <div class="toast-box">
                    ...
                    <div class="toast-content">
                        ...
                        <span>Data jurusan baru berhasil disimpan.</span>
                    </div>
                </div>
            <?php endif; ?>
        <?php endif; ?>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow-sm">
                    ...
                    <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100">
                        <span class="text-gray-700 font-weight-bold">
                            <i class="fas fa-school text-info mr-2"></i>Kelola Data Program Keahlian / Jurusan
                        </span>
                    </div>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div>
                            <h1 class="h3 mb-0 text-gray-800">
                                <i class="fas fa-school mr-2 text-info"></i>Manajemen Data Jurusan
                            </h1>
                            <p class="page-subtitle">Daftar konsentrasi keahlian / jurusan SMK Negeri 1 Ciomas</p>
                        </div>
                        <a href="tambahjurusan.php" class="btn btn-info shadow-sm">
                            <i class="fas fa-plus mr-1"></i> Tambah Jurusan Baru
                        </a>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <span class="font-weight-bold text-info">
                                <i class="fas fa-table mr-2"></i>Tabel Data Jurusan
                                <span class="badge badge-info ml-2" style="font-size: 0.8rem; border-radius: 6px;"><?= $total_jurusan ?> Jurusan</span>
                            </span>
                            <div class="form-inline">
                                <input type="text" id="searchInput" class="form-control form-control-sm" placeholder="Cari nama / kode..." style="width: 200px;">
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        if ($data && mysqli_num_rows($data) > 0) {
                                            while ($j = mysqli_fetch_array($data)) {
                                                $id_val = isset($j['id']) ? $j['id'] : (isset($j['id_jurusan']) ? $j['id_jurusan'] : (isset($j['kode']) ? $j['kode'] : ''));
                                        ?>
                                        <tr>
                                            <td class="text-center font-weight-bold text-muted"><?= $i++ ?></td>
                                            <td class="font-weight-bold text-gray-900">
                                                <i class="fas fa-book-reader text-gray-400 mr-2"></i>
                                            ...
                                            <td>
                                                ...
                                                <?= htmlspecialchars($j['ketua']) ?>
                                            </td>
                                            <td class="text-center">
                                                <a href="editjurusan.php?id=<?= urlencode($id_val) ?>" class="btn-action btn-edit" title="Edit Data Jurusan">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button type="button" 
                                                        class="btn-action btn-delete" 
                                                        title="Hapus Jurusan" 
                                                        onclick="confirmDeleteJurusan('<?= htmlspecialchars(addslashes($id_val)) ?>', '<?= htmlspecialchars(addslashes($j['nama'])) ?>')">
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-5 text-muted">
                                                ...
                                                Belum ada data jurusan yang tersimpan.
                                                <br>
                                                <a href="tambahjurusan.php" class="btn btn-sm btn-info mt-3">
                                                    <i class="fas fa-plus mr-1"></i> Tambah Jurusan Sekarang
                                                </a>
                                            </td>
                                        </tr>
                                        <?php } ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content text-center p-4">
                <div class="modal-body">
                    ...
                    <h4 class="font-weight-bold text-gray-900 mb-2">Hapus Data Jurusan?</h4>
                    <p class="text-muted mb-4">
                        Apakah Anda yakin ingin menghapus jurusan <strong id="deleteNama" class="text-danger"></strong>?
                        <br><small class="text-muted">Data jurusan yang dihapus tidak dapat dipulihkan kembali.</small>
                    </p>
    ...
    <script>
        function confirmDeleteJurusan(id, nama) {
            document.getElementById('deleteNama').innerText = nama;
            document.getElementById('btnConfirmDelete').href = 'hapusjurusan.php?id=' + encodeURIComponent(id);
        ...
        $('#searchInput').on('keyup', function() {
            ...
            $('#jurusanTable tbody tr').filter(function() {
