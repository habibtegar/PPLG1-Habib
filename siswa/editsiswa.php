...
// Deteksi kolom kunci pada tabel siswa secara otomatis
...
$query = mysqli_query($koneksi, "SELECT * FROM siswa WHERE $where_clause");
$siswa = $query ? mysqli_fetch_assoc($query) : null;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result) {
        header("Location: siswa.php?status=updated&nama=" . urlencode($nama));
        exit;
    } else {
...
<head>
    ...
    <title>Edit Data Siswa - PPLG 1</title>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow-sm">
                ...
                <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100">
                    <span class="text-gray-700 font-weight-bold">
                        <i class="fas fa-user-edit text-primary mr-2"></i>Edit Informasi Siswa
                    </span>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="mb-4">
                    ...
                    <h1 class="h3 mb-0 text-gray-800">
                        <i class="fas fa-user-edit mr-2 text-primary"></i>Edit Data Siswa
                    </h1>
                    <p class="page-subtitle">Perbarui data biodata dan profil siswa</p>
                </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex align-items-center justify-content-between">
                                <span class="font-weight-bold text-primary">
                                    <i class="fas fa-edit mr-2"></i>Formulir Edit Siswa: <u><?= htmlspecialchars($siswa['nama']) ?></u>
                                </span>
                            </div>
                                ...
                                <form method="POST" action="">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="nama" name="nama" class="form-control"
                                               value="<?= htmlspecialchars($siswa['nama']) ?>" placeholder="Masukkan nama lengkap" required>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input type="text" id="nisn" name="nisn" class="form-control"
                                                   value="<?= htmlspecialchars($siswa['nisn']) ?>" placeholder="Contoh: 0054321890" required>
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input type="email" id="email" name="email" class="form-control"
                                                   value="<?= htmlspecialchars($siswa['email']) ?>" placeholder="nama@domain.com" required>
                                        </div>
                                    </div>
