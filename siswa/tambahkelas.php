...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query  = "INSERT INTO kelas (nama, jurusan, wali_kelas, ruangan) VALUES ('$nama', '$jurusan', '$wali_kelas', '$ruangan')";
    $result = mysqli_query($koneksi, $query);

    if ($result) {
        header("Location: kelas.php?status=added&nama=" . urlencode($nama));
        exit;
    } else {
        $error_message = "Gagal menambahkan data kelas: " . mysqli_error($koneksi);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Tambah Kelas Baru - PPLG 1</title>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow-sm">
                ...
                <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100">
                    <span class="text-gray-700 font-weight-bold">
                        <i class="fas fa-plus-circle text-success mr-2"></i>Registrasi Rombel Kelas Baru
                    </span>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="mb-4">
                    ...
                    <h1 class="h3 mb-0 text-gray-800">
                        <i class="fas fa-plus-circle mr-2 text-success"></i>Tambah Kelas Baru
                    </h1>
                    <p class="page-subtitle">Daftarkan data rombel kelas baru dan tentukan wali kelasnya</p>
                </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <span class="font-weight-bold text-success">
                                    <i class="fas fa-chalkboard mr-2"></i>Formulir Data Kelas Baru
                                </span>
                            </div>
                            <div class="card-body p-4">
                                <form method="POST" action="">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="nama" name="nama" class="form-control" placeholder="Contoh: X PPLG 1 / XII TKJ 2" required>
                                    </div>
                                        ...
                                        <select id="jurusan" name="jurusan" class="form-control" required>
                                            ...
                                            if ($list_jurusan && mysqli_num_rows($list_jurusan) > 0) {
                                                while ($j = mysqli_fetch_array($list_jurusan)) {
                                                    $has_options = true;
                                            ?>
                                                    <option value="<?= htmlspecialchars($j['kode']) ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input type="text" id="wali_kelas" name="wali_kelas" class="form-control" placeholder="Nama Guru Wali Kelas" required>
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input type="text" id="ruangan" name="ruangan" class="form-control" placeholder="Contoh: Ruang 101 / Lab Komputer" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-success px-4">
                                            <i class="fas fa-check mr-1"></i> Simpan Data Kelas
                                        </button>
                                    </div>
                                </form>
                            </div>
